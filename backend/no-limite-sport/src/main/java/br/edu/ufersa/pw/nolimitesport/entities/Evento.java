...
public class Evento {
	...
	private String infoComplamentar;
	...
	public String getInfoComplamentar() {
		return infoComplamentar;
	}
	public void setInfoComplamentar(String infoComplamentar) {
		this.infoComplamentar = infoComplamentar;
	}
